        ...
        <section class="ml-3">
            ...
            <div class="flex flex-wrap justify-start 
                ...
                <article class="flex flex-col sm:flex-wrap gap-2">
                    ...
                    <div class="flex flex-col">
                        <input name="name"
                            class="w-full shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300 min-h-[125px] 
                            min-w-[250px]"
                            id="description" placeholder="Descripción de la actividad">{{ old('description', $activity->description ?? '') }}</textarea>
                        @error('description')
                            <span class="text-red-500 text-sm dark:text-red-400">
                                {{ $message }}
                            </span>
