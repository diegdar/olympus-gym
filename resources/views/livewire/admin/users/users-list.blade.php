<div wire:poll.5s class="dark:bg-gray-800 dark:text-gray-100">
    ...
    <div class="w-full px-4">
        ...
        <h2 class= "sm:text-start text-2xl dark:text-gray-100">Listado de usuarios ({{ $usersCount }})</h2>
    </div>
    {{-- filter and search --}}
    ...
    @if ($users->count())
        ...
        <table class="min-w-full leading-normal">
            <thead>
                <tr>
                    <th class="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-lg font-bold uppercase dark:bg-gray-900 dark:border-gray-700 dark:text-red-300">
                        Nº
                    </th>
                    <th class="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-lg font-bold uppercase dark:bg-gray-900 dark:border-gray-700 dark:text-red-300">
                        Nombre
                    ...
                    <th class="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-lg font-bold uppercase dark:bg-gray-900 dark:border-gray-700 dark:text-red-300">
                        Acción
                    </th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr class="dark:bg-gray-800 dark:border-gray-700 block md:table-row dark:hover:bg-gray-100">
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300 block md:table-cell">
                    ...
                    <td class="py-0 sm:py-3 border-b border-gray-200 bg-white text-sm dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300  md:table-cell">
                        ...
                        <div class="flex flex-row sm:flex-col justify-center items-center gap-4 sm:gap-0">
                            ...
                            @can('admin.users.destroy')
                                <form method="POST" 
                                    action="{{ route('admin.users.destroy', $user->id) }}" class="inline-block ">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="block w-[50px] mt-0 sm:mt-2 text-white-600 bg-red-500 hover:bg-red-600 px-2 py-1 rounded cursor-pointer"
